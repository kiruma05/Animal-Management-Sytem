...
const startDataLight = [
  ...
  {
    duration: "6-7 Calves-Steers",
    value: 4,
    color: "#22c55e",
  },
  {
    duration: "8-14 Cull-Breeding",
    value: 2,
    color: "#14b8a6",
  },
  {
    duration: "15-21 Bulls-Weaners",
    value: 2,
    color: "#3b82f6",
  },
  {
    duration: "21+ Calves-steers",
    value: 0,
    color: "#a855f7",
  },
];
...
function DurationChart({ confirmedStays }) {
  return (
    <ChartBox>
      <Heading as="h2">Sub-Categories of Cattles in Ranchies</Heading>
